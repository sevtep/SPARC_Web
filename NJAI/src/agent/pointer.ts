// Virtual Pointer Component - renders a pointer that moves smoothly
...
function ensurePointer(): HTMLDivElement {
...
export function showPointer(): void {
...
export function movePointerTo(targetX: number, targetY: number, duration: number = 400): Promise<void> {
...
export function VirtualPointer() {
  useEffect(() => {
    // Ensure pointer is created on mount
    ensurePointer()
